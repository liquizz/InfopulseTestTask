    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderCommentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderCommentsOrderCommentId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_OrderComments_OrderCommentsOrderCommentId",
                        column: x => x.OrderCommentsOrderCommentId,
                        principalTable: "OrderComments",
                        principalColumn: "OrderCommentId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_OrderCommentsOrderCommentId",
                table: "Orders",
                column: "OrderCommentsOrderCommentId");
